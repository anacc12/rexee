    ...
    return (
        <div className="w-full mx-auto">
            <div className="mt-10 flex flex-col items-center justify-center">
                ...
                <div>
                    <h2 className="text-center text-text-dark text-xl font-semibold leading-loose pb-1">
                        {props.title}
                    </h2>
                    <p className="text-center text-text-light text-base font-normal leading-relaxed pb-4 max-w-[300px]">
                        {props.message}
                    </p>
                </div>
            </div>
